...
import '../protobuf/any.pb.dart' as $19;
import '../rpc/status.pb.dart' as $20;
import '../protobuf/duration.pb.dart' as $21;
...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.longrunning'), createEmptyInstance: create)
    ...
    ..aOM<$19.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: $19.Any.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'done')
    ..aOM<$20.Status>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $20.Status.create)
    ..aOM<$19.Any>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'response', subBuilder: $19.Any.create)
  ...
  @$pb.TagNumber(2)
  $19.Any get metadata => $_getN(1);
  @$pb.TagNumber(2)
  set metadata($19.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $19.Any ensureMetadata() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $20.Status get error => $_getN(3);
  @$pb.TagNumber(4)
  set error($20.Status v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasError() => $_has(3);
  @$pb.TagNumber(4)
  void clearError() => clearField(4);
  @$pb.TagNumber(4)
  $20.Status ensureError() => $_ensure(3);

  @$pb.TagNumber(5)
  $19.Any get response => $_getN(4);
  @$pb.TagNumber(5)
  set response($19.Any v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponse() => clearField(5);
  @$pb.TagNumber(5)
  $19.Any ensureResponse() => $_ensure(4);
}
...
class WaitOperationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WaitOperationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.longrunning'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$21.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeout', subBuilder: $21.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $21.Duration get timeout => $_getN(1);
  @$pb.TagNumber(2)
  set timeout($21.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTimeout() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimeout() => clearField(2);
  @$pb.TagNumber(2)
  $21.Duration ensureTimeout() => $_ensure(1);
}
